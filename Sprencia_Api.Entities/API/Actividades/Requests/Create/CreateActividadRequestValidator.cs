...
{
    public class CreateActividadRequestValidator : AbstractValidator<CreateActividadRequest>
    {
        int caracterDescription = 10;
        public CreateActividadRequestValidator()
        {
            RuleFor(x => x.Nombre)
                ...
                .MaximumLength(50).WithMessage("El campo no nombre no puede tener más de 50 caracteres");
            RuleFor(x => x.Precio)
